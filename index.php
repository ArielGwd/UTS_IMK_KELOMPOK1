        ...
        <div class="md:flex gap-6 py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12">
            <aside>
                ...
                <?php if (isset($_SESSION['user']['role']) && $_SESSION['user']['role'] === 'admin' || $_SESSION['user']['role'] === 'petugas') { ?>
                    <ul class="mt-6">
                        <li>
                            <button data-modal-target="add-modal" data-modal-toggle="add-modal" type="button" class="inline-flex items-center cursor-pointer text-center px-6 py-3 text-white bg-green-600 rounded-lg w-full hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600">
            ...
            <div style="height: 120px;" class="background p-6 md:ml-2 bg-white text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full rounded-lg">
                <?php
