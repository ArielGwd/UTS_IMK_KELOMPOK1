<div class="p-6 md:ml-2 bg-white text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full rounded-lg">
    <div class="flex items-center">
        <div class=" flex-1">
            <h3 class="text-lg font-bold text-xl text-violet-800 dark:text-violet-600">Data Siswa</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Berikut adalah data siswa yang terdaftar</p>
        </div>
...
<div class="relative overflow-x-auto pt-2 pl-2 mt-6">
    ...
    <table id="pagination-table" class="bg-white w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg">
        ...
        <tbody>
            ...
            $query = 'SELECT students.*, users.* FROM students 
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="inline-flex items-center justify-center w-full">
                            <div class="inline-flex items-center gap-2 justify-center w-full">
                                <?php $lowerAndNotDash = strtolower(str_replace('-', '', $student->id)); ?>
                                ...
                                <div id="edit-modal<?= $lowerAndNotDash ?>" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        <?php
                                        $student = $koneksi->query("SELECT students.*, users.* FROM students INNER JOIN users ON students.user_id = users.id WHERE students.user_id='$student->user_id'")->fetch_object(); ?>
                                        <form class="relative text-left bg-white rounded-lg shadow-sm dark:bg-gray-700 bookForm" action="../Requests/StudentRequest.php?action=update" method="POST">
                                            <!-- Modal header -->
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                ...
                                                <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                    <div>
                                                        ...
                                                        <input type="text" id="username-update<?= $lowerAndNotDash ?>" name="username" value="<?= htmlspecialchars($student->username); ?>" class="username bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500" placeholder="sky_seven" required />
                                                    </div>
                                                    <div>
                                                        <label for="nama-update<?= $lowerAndNotDash ?>" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Siswa</label>
                                                        <input type="text" id="nama-update<?= $lowerAndNotDash ?>" name="nama" value="<?= htmlspecialchars($student->nama_siswa); ?>" class="nama bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500" placeholder="Habibie" required />
                                                    </div>
                                                    ...
                                                    <div>
                                                        <label for="kelas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelas <span class="text-red-400">*</span></label>
                                                        <input type="text" id="kelas-update<?= $lowerAndNotDash ?>" name="kelas" value="<?= htmlspecialchars($student->kelas); ?>" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500" placeholder="Engineering A" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin menghapus data <?= $student->nama_siswa ?>?</h3>

                                                <div class="inline-flex items-center justify-center">
                                                    <form action="../Requests/StudentRequest.php?action=delete" method="post"
...
<div id="add-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <form class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700" id="addBookForm" action="../Requests/StudentRequest.php?action=add" method="POST">
            <!-- Modal header -->
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    Tambah Data Siswa
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="kelas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelas <span class="text-red-400">*</span></label>
                        <input type="text" id="kelas" name="kelas" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500" placeholder="Engineering A" />
                    </div>
                </div>
            </div>
